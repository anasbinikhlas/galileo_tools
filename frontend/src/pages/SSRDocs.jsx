  ...
  return (
    <header className="bg-white border-b border-gray-200 px-6 py-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
      ...
      <div className="flex items-center gap-2">
        ...
        <span className="text-xs font-semibold text-gray-600 font-mono">Travelport Galileo Connected</span>
      </div>
    </header>
  )
}
...
export default function App() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50 text-gray-900 antialiased font-sans">
      ...
      <Topbar title="SSR Docs Formatter" subtitle="— Travelport Galileo Integration Toolkit" />
